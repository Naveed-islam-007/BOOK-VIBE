...
const BookDetails = () => {
  ...
  const { handleClick, handleWishList } = useContext(BookContext); 
    ...
    <div className="grid grid-cols-2 bg-base-100 shadow-sm container mx-auto my-8">
      ...
      <div className="card-body space-y-3">
        ...
        <div className="border-t space-y-3">
          ...
          <div className="flex items-center gap-2">
            <button className="btn" onClick={() => handleClick(expBook)}>
              Mark as Read
            </button>
            <button className="btn btn-primary" onClick={() => handleWishList(expBook)}>
              Add to Wishlist
            </button>
          </div>
        </div>
